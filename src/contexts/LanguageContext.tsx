...
const translations = {
  de: {
    ...
    'solution.step1.desc': 'Bauleiter telefoniert ganz normal über das EdgeCrew-System.',
  ...
  en: {
    ...
    'solution.step1.desc': 'Construction manager calls normally via the EdgeCrew system.',
